<template>
    <div class="pager">     
        <navigator href="javascript:void(0);" v-show="showFirstPage" @click="firstPage" >首页</navigator>
        <navigator href="javascript:void(0);" v-show="showPrevPage" @click="prevPage" >上一页</navigator>
        <navigator href="javascript:void(0);" v-show="showNextPage" @click="nextPage" >下一页</navigator>
        <navigator href="javascript:void(0);" v-show="showLastPage" @click="lastPage" >尾页</navigator>
        <div>
